...
const Side = () => {
    ...
    return (
        <>
            <div style={{ minHeight: "750px" }} class="w-64 absolute sm:relative bg-gray-800 shadow md:h-full flex-col justify-between hidden sm:flex">
                        <div class="px-8">
                            <div class="h-24 w-full flex items-center text-gray-300">
                                <h1 className='italic font-bold w-16 text-3xl'>webDoc</h1>
                            </div>
                            <ul class="mt-12">
                                ...
                                <li class="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center">
                                    <a href="javascript:void(0)" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" width="18" height="18" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="feather feather-log-out">
                                            <path d="M9 5H5v14h4" />
                    ...
                    <div class="w-64 z-40 absolute bg-gray-800 shadow md:h-full flex-col justify-between sm:hidden transition duration-150 ease-in-out" id="mobile-nav" style={{ transform: isSidebarOpen ? "translateX(0px)" : "translateX(-260px)" }}>
                        <button aria-label="toggle sidebar" id="openSideBar" class={`h-10 w-10 bg-gray-800 absolute right-0 mt-16 -mr-10 flex items-center shadow rounded-tr rounded-br justify-center cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 rounded focus:ring-gray-800 ${!isSidebarOpen ? "" : "hidden"}`} onClick={() => handleSidebar(true)}>
                        ...
                        <button aria-label="Close sidebar" id="closeSideBar" class={`h-10 w-10 bg-gray-800 absolute right-0 mt-16 -mr-10 flex items-center shadow rounded-tr rounded-br justify-center cursor-pointer text-white ${isSidebarOpen ? "" : "hidden"}`} onClick={() => handleSidebar(false)}>
                        ...
                        <div class="px-8">
                            <div class="h-16 w-full flex items-center text-white">
                                <h1 className='italic font-bold w-16 text-3xl'>webDoc</h1>
                            </div>
                            <ul class="mt-12">
