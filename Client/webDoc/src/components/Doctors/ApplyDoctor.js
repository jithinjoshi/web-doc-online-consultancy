...
import { applyDoctor, getAllDepartments } from '../../Helpers/doctorHelper';
...
const ApplyDoctor = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async values => {
            ...
            const img = { image: image, dob: date, certificate: certificate, startTime: startTime, endTime: endTime}
